...
class HomeRentalInsurance:
    ...
    def display_and_save_data(self, df_cleaned, output_file_path):
        ...
        print(f"The dataset can be found within the following directory: {output_file_path}.")
...
class CensusMigration:
    ...
    def __init__(self):
        self.census_raw_files_folder = "Data\State to State Migration Flows - Raw Excel Data"
        self.census_cleaned_files_folder = "Data\State to State Migration Flows - Cleaned Excel Data"
